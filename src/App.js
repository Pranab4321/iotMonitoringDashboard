...
function App() {
  return (
    <div className='m-page'>
      <Navbar />
      <div id="dashboard" style={{padding: '0.5rem 1rem',width:'95.12vw',height:"21px"}}></div>
      ...
      <footer style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#0078d7', color: 'white', position: 'fixed', bottom: 0, width: '95.12vw' }}>
